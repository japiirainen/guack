...
export interface MalformedRequestError extends MO.AType<typeof MalformedRequestError_> {}
export interface MalformedRequestErrorE extends MO.EType<typeof MalformedRequestError_> {}
